...
public:
    ...
    double time_mat_pred;
    //
    double lmk_num_refTrack;
    double lmk_num_refInlier;
    double lmk_num_initTrack;
    double lmk_num_BA;
    // obselet
    double lmk_num_good;
...
class MatchingLog {
public:
    MatchingLog(size_t m_, double a_) : match_try(m_), accu_logDet(a_) {}
    size_t match_try;
    double accu_logDet;
};
