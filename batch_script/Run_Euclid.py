...
SeqNameList = ['2017-10-30-20-04-41'];
# SeqNameList = ['2017-10-30-18-50-57', '2017-10-30-20-04-41'];
...
for ri, num_gf in enumerate(Number_GF_List):
    ...
    for iteration in range(0, Num_Repeating):
        ...
        for sn, sname in enumerate(SeqNameList):
            ...
            cmd_slam   = str('rosrun GF_ORB_SLAM GF_ORB_SLAM ' + File_Vocab + ' ' + File_Setting + ' ' + str(Number_GF_List[ri]) + ' /camera/fisheye/image_raw ' + File_traj)
